...
export default function TypewriterTitle({
    ...
    return (
        <div className="relative w-full max-w-4xl mx-auto px-4 py-4 sm:py-6">
            <div
                className="relative text-center z-10 flex flex-col items-center justify-center"
                ref={scope}
            >
                <motion.div className="text-[18px] md:text-[20px] font-normal text-gray-400 leading-[0] tracking-normal"
  initial={{ opacity: 0 }}
  animate={{ opacity: 1 }}
>
                    <span
